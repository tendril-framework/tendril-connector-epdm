...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-connector-epdm',
    project_urls={
        'Documentation': 'https://tendril-connector-epdm.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-connector-epdm/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-connector-epdm',
    },
